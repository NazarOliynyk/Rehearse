package Multithreading.Mutex_Semaphore.SecondTutorial;

import java.util.concurrent.Semaphore;

public class SemaphoreTestWithMutex {

    // max 1 people  -  the same semaphore but with argument 1
    private static Semaphore semaphore = new Semaphore(1);

    private static class MyLockerThread extends Thread {
